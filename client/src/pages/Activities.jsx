...
const Activities = () => {
  ...
  const activitiesData = [
    ...
    },
    {
      ...
      title: "Sports Fest",
      description:
        "The Sports Fest at GD Goenka Aligarh was a celebration of athleticism and teamwork. Students participated in various sports events, demonstrating their physical fitness, sportsmanship, and competitive spirit. The day was filled with excitement, and winners were celebrated with enthusiasm.",
      image: SportsFestImage, // Replace with actual image import
    },
    {
      id: 5,
    ...
    },
    {
      ...
      image: Art, // Replace with actual image import
    },
    {
      id: 17,
      title: "Horse Riding",
      ...
      image: HorseRiding, // Replace with actual image import
    }
  ];
