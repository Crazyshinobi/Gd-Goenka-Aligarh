...
export const ParentInformation = ({ onBack, onNext }) => {
  ...
  const fetchDetails = async () => {
    try {
      ...
      if (response?.data?.success && response.data.admission?.parents_information) { 
        ...
        if (parentsInfo.some((p) => p.parent_type === "guardian")) {
          ...
          const guardian = parentsInfo.find((p) => p.parent_type === "guardian");
          ...
          const father = parentsInfo.find((p) => p.parent_type === "father") || {};
          const mother = parentsInfo.find((p) => p.parent_type === "mother") || {};
